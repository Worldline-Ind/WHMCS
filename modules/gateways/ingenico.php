 ...
 * example file, the filename is "ingenico" and therefore all functions
 * begin "ingenico_".
 *
...
function ingenico_config()
{
    ...
    return array(
        ...
        'description' => array(
            ...
            'Size' => '25',
            'Default' => '',
            'Description' => 'Ingenico ePayments (a Worldline brand) is Indias leading digital payment solutions company. Being a company with more than 45 years of global payment experience, we are present in India for over 20 years and are powering over 550,000 businesses with our tailored payment solution',
        ),
        ...
        'enableNewWindowFlow' => array(
            'FriendlyName' => 'Enable New Window Flow',
            'Type' => 'dropdown',
            'Options' => array(
                1 => 'Yes',
                0 => 'No',
            ),
            'Description' => 'If this feature is enabled, then bank page will open in new window',
        ),
        'merchantmsg' => array(
        ...
        'paymentMode' => array(
            ...
            'Description' => 'If Bank selection is at Ingenico ePayments India Pvt. Ltd. (a Worldline brand) end then select all, if bank selection at Merchant end then pass appropriate mode respective to selected option',
        ),
...
$newid = insert_query($table,$insert_array);
    ...
    return <<<EOT
    <input id="btnSubmit" type="submit" value="$langPayNow" />
    <br><br>
<div id="ingenicopayment"></div>
<form action="$callbackurl2" id="response-form" method="POST">
 ...
 */
function ingenico_refund($params)
{
    // Gateway Configuration Parameters
    ...
    $request_array = array("merchant"=>array("identifier"=>$merchantCode),
                                "cart"=>(object) null,
                                "transaction"=>array(
                                    "deviceIdentifier"=>"S",
                                    "amount"=>$refundAmount,
